...
function Missionary({ onClick, interactive, inBoat = false }) {
  return (
    <motion.div
      className={`group relative flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-gradient-to-b from-blue-400 to-blue-600 text-xs font-bold text-white shadow-md transition-colors duration-300 ${
        interactive ? "hover:from-blue-300 hover:to-blue-500" : "opacity-80"
      }`}
      style={{
